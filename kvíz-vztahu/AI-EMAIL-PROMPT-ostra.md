# AI Email Prompt — kvíz po vyhodnocení (OSTRÁ verze)

> Verze 1.4 / 2026-06-01 · Cliqsales AI / Claude API → personalizovaný e-mail výsledku
>
> ✅ OSTRÁ (produkční) verze — BEZ testovacího výpisu dat. Data respondenta se do
> e-mailu nevypisují. Pro ladění použij DEBUG verzi (stare) se sekcí „TESTOVACÍ REŽIM".
>
...
<a href="https://restartmuze.cz/kviz-vztahu/sdilej/?ref={{contact.id}}" style="display:inline-block;background:#002338;color:#ffffff;font-family:Montserrat,Arial,sans-serif;font-weight:700;font-size:20px;text-decoration:none;padding:16px 40px;border-radius:100px;letter-spacing:0.04em;"><span style="color:#ffffff;">Pošli kvíz kamarádovi →</span></a>
</p>
